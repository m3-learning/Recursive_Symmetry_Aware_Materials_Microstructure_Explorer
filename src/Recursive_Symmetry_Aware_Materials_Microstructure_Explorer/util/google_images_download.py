...
class googleimagesdownload:
    ...
    def build_search_url(self, search_term, params, url,
        ...
        :param similar_images: Check for similar images
        :param specific_site: specifies a specific site to serach
        :param safe_search: boolan to determine if safe search on
        :return:
        """
        # check safe_search
    ...
    def create_directories(self, main_directory, dir_name,
        ...
        :param thumbnail_only: Selects if only a thumbnail is stored
        :return:
        """
    ...
    def download_image_thumbnail(self, image_url, main_directory, dir_name, return_image_name, print_urls,
        ...
        :param return_image_name: name of image that will be saved
        :param print_urls: Selects if you print the URLs when scraping
        :param socket_timeout: Time before a process timesout
        :param print_size: Boolian to print the size of the files
        :param no_download: Function to check the process without downloading files
        :param save_source: Save the source file
        :param img_src: Source of the image
        :param ignore_urls: Specific urls to ignore
        :return:
        """
    ...
    def download_image(self, image_url, image_format, main_directory, dir_name, count, print_urls, socket_timeout,
        ...
        :param dir_name: subdirectory where images are saved
        :param count: number of images to save
        :param print_urls: Boolian to print URLS
        :param socket_timeout: time before process timeouts
        :param prefix: prefix to add to the files
        :param print_size: prints the file size
        :param no_numbering: selects if you number the files
        :param no_download: selects if you download the files
        :param save_source: selects if you save the webpage source
        :param img_src: save the direction to the image source
        :param silent_mode: sets the download operation to silent mode
        :param thumbnail_only: saves the thumbnail only
        :param format: Sets the format that files will be saved
        :param ignore_urls: Sets what URLS to ignore based on keywords
    ...
    def _get_all_items(self, image_objects, main_directory,
        ...
        :param limit: Limit on number of files
        :param arguments: dictionary of additional arguments to consider
        :return:
        """
        items = []
        abs_path = []
